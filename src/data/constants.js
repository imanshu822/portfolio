export const Bio = {
  ...
  github: "https://github.com/imanshu822",
  resume:
    "https://drive.google.com/file/d/1ENVM1Z7RsaWocCchoedYKbbuWoApWwUr/view?usp=drive_link",
  linkedin: "https://www.linkedin.com/in/imanshu822/",
  twitter: "https://x.com/imansh822",
  insta: "https://www.instagram.com/i.m.anshu/",
  facebook: "https://www.facebook.com/imaanshu",
};
...
export const experiences = [
  {
    ...
    desc: "I led a team of four MERN developers and successfully completed three projects: Saniiro, Privily, and MobyInk. For the Saniiro website, I developed and implemented over 50 interactive web pages using React, significantly enhancing the user experience. In the Privily project, I built a secure backend with Node.js and Express, featuring user authentication, pod booking, email confirmation, a feature-rich admin portal with over 110 API calls, and IoT device integration for pod gate access. For the MobyInk website, I redesigned and developed more than 60 pages using Next.js and Material UI, resulting in a 30 percent increase in user engagement and a 15 percent rise in incoming leads.",
    skills: [
      "ReactJS",
      "Redux",
      "NodeJs",
  ...
  },
  {
    ...
    desc: "As a Backend developer at the WaysAhead Global, I have had the opportunity to work on exciting projects and collaborate with talented developers who share my passion for technology. Through my involvement with GDCS, I have also had the opportunity to host and participate in numerous events, including hackathons, study jams, and workshops.",
    skills: [
      "Leadership",
